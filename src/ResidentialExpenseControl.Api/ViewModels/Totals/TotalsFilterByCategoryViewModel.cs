...
{
    public class TotalsFilterByCategoryViewModel
    {
        /// <summary>
        ...
        /// </summary>
        [EnumDataType(typeof(TotalsCategoryOrderBy), ErrorMessage = "O tipo de ordenação é inválido")]
        [JsonConverter(typeof(JsonStringEnumConverter))]
        public TotalsCategoryOrderBy? OrderBy { get; set; }
